...
},{}],"assets/svg/navbarShapes.js":[function(require,module,exports) {
"use strict";
...
},{"buffer":"../node_modules/buffer/index.js"}],"webgl/gl_utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.start_gl = start_gl;
// Start time
var time0 = new Date().getTime() / 1000; // Define a general purpose 3D vector object.
...
function getStringFromDOMElement(id) {
  var node = document.getElementById(id); // Recurse and get all text in the node
...
function gl_init(gl, vertexShader, fragmentShader) {
  ...
  gl.useProgram(program); // Create a square as a strip of two triangles.
...
function gl_update(gl) {
  ...
  gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4); // Start the next frame
...
function start_gl(canvas_id, vertexShader, fragmentShader) {
  ...
  function setMouse(z) {
    ...
    if (z !== undefined) gl.cursor.z = z;
  }

  canvas.onmousedown = function (event) {
    setMouse(1);
  }; // On mouse down, set z to 1.
  ...
  canvas.onmouseup = function (event) {
    setMouse(0);
  }; // On mouse up  , set z to 0


  gl.cursor = new Vector3(); // Initialize gl. Then start the frame loop.
...
var _background = require("../webgl/background");
...
var animateBgOnScroll = function animateBgOnScroll() {
  document.addEventListener("scroll", function () {
    var height = document.body.offsetHeight - window.innerHeight;
    var position = window.pageYOffset;
    bg.style.filter = "hue-rotate(".concat(position / height * 360, "deg)");
    bg.style.opacity = 0.9 - position / height * 0.6;
  });
};

var animateFirstText = function animateFirstText() {
  (0, _anime.default)({
  ...
  var firstTextSpans = document.querySelectorAll(".first-text span");
  var perspectives = [-1.2, 3, -1.5, 2, 3, 2.3];
  firstTextSpans.forEach(function (text, index) {
    var color = Math.random() * -90 + 45;
    text.style.backgroundImage = window.innerWidth > 620 ? "linear-gradient(hsl(".concat(color, ", 65%, 55%), hsl(").concat(color, ", 15%, 15%))") : "linear-gradient(hsl(".concat(color, ", 10%, 55%), hsl(").concat(color, ", 0%, 15%))");
    text.style.zIndex = perspectives[index] > 0 ? perspectives[index] * 10 : 1;
    text.style.fontSize = "".concat(Math.abs(perspectives[index]) * (window.innerWidth > 620 ? 3 : 2), "rem");
    var firstContent = document.querySelector(".front-full-size");
    firstContent.addEventListener("mousemove", function (event) {
      var offsetX = window.innerWidth / 2 - event.clientX;
      var offsetY = window.innerHeight / 2 - event.clientY;
      var q = 0.051 * perspectives[index];
      var qZ = Math.abs(offsetX * offsetY) * q * 0.001;
      text.style.transform = "\n                                    translate(".concat(offsetX * q, "px, ").concat(offsetY * q, "px) \n                                    rotate(").concat(qZ * (perspectives[index] * (offsetX * offsetY) < 1 ? 1 : -1), "deg)");
    });
  });
};
},{"animejs/lib/anime.es":"../node_modules/animejs/lib/anime.es.js","../assets/svg/navbarShapes":"assets/svg/navbarShapes.js","lodash":"../node_modules/lodash/lodash.js","../webgl/background":"webgl/background.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./../assets/images/ep_naturalwhite.png":[["ep_naturalwhite.e12a4eb8.png","assets/images/ep_naturalwhite.png"],"assets/images/ep_naturalwhite.png"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/newspaper.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./../assets/fonts/impact_label/impact_label_reversed.ttf":[["impact_label_reversed.ef990b55.ttf","assets/fonts/impact_label/impact_label_reversed.ttf"],"assets/fonts/impact_label/impact_label_reversed.ttf"],"./../assets/fonts/fipty_serif/fipty_serif.ttf":[["fipty_serif.78122825.ttf","assets/fonts/fipty_serif/fipty_serif.ttf"],"assets/fonts/fipty_serif/fipty_serif.ttf"],"./../assets/fonts/heading/heading_bold.ttf":[["heading_bold.4c4dc5a9.ttf","assets/fonts/heading/heading_bold.ttf"],"assets/fonts/heading/heading_bold.ttf"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/modern.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
},{"./newspaper/animations":"newspaper/animations.js","./css/styles.css":"css/styles.css","./css/newspaper.scss":"css/newspaper.scss","./css/modern.scss":"css/modern.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
